            ...
            <div className="max-w-1500  mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-[40px] shadow-2xl shadow-gray-200 
                    ...
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-2xl sm:text-4xl  text-gray-900 tracking-tight mb-3">
                            More About Us
                        </h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-12 lg:gap-16 text-center">
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                <p className="text-4xl sm:text-xl lg:text-5xl font-medium text-gray-900 mb-1 -mt-7 leading-tight">
                                    {stat.number}
                                </p>
                                {/* Label: Clear, readable text */}
                                <p className="text-sm sm:text-base  text-gray-900 tracking-wide font-bold  -mt-1">
                                    {stat.label}
                                </p>
                            </div>
                        ))}
