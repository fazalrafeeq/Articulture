 ...
 const FIXED_DIMENSIONS_MD = 'w-[300px] h-[500px]' 
  ...
  return (
    ...
    <div className="flex justify-center p-4 sm:p-8 lg:p-12 bg-gray-50">
      ...
      <div className="max-w-350 max-h-250 bg-white rounded-xl shadow-2xl p-6 lg:p-10">
        
        {/* Main Content Layout: Stacks on SM, splits 1/3 (text) and 2/3 (images) on LG */}
        <div className="flex flex-col lg:flex-row gap-8"> {/* Increased gap for separation */}
          
          {/* A. Text/Profile Column (Left Side) - WIDTTH IS FIXED AT LG:W-1/3 */}
          ...
          <div className="w-full md:h-1/2 lg:w-2/3">
            {/* The wrapper for the scrolling images: 
                ...
                - snap-x snap-mandatory: ***SNAP-TO-CENTER CAROUSEL EFFECT***
                - space-x-4: Adds horizontal space between items on small screens
            ...
            */}
            <div className="flex overflow-x-scroll snap-x snap-mandatory space-x-4 pb-4 
              ...
              <div className={`flex-shrink-0 w-4/5 sm:w-11/12 md:w-auto md:col-span-1 
                              h-96 md:${FIXED_DIMENSIONS_MD}  lg:${FIXED_DIMENSIONS_LG} relative rounded-lg overflow-hidden snap-center`}> 
                  <Image 
                      src="/image/abt-2.png" 
                      alt="Modern Kitchen" 
                      fill
