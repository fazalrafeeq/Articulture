  ...
  return (
    <nav className=" absolute top-4 left-0 w-full flex md:top-7 justify-between items-center px-6 md:px-10 py-4 text-white z-30">
      ...
      <ul className="hidden md:flex items-center gap-6 md:gap-6  lg:gap-10 text-base md:text-sm  font-medium">
        <Link href={`/`} > <li className="text-green-400 cursor-pointer hover:text-gray-300">Home</li></Link>
        <Link href={`/About`}> <li className="cursor-pointer hover:text-emerald-300 ">About us</li>
        </Link>
        <Link href={`/Portfolio`} ><li className="cursor-pointer hover:text-emerald-300">Portfolio</li></Link>
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-end z-50">
          ...
          <div className="w-64 h-full bg-gradient-to-b from-gray-200 to-white shadow-xl p-6 animate-mobile-slide border-l border-gray-300">
            ...
            <ul className="flex flex-col gap-4 mt-14 text-gray-900 font-semibold text-lg">
              <Link href={`/`} > <li className="pb-3 border-b border-gray-300">Home</li></Link>
              <Link href={`/About`} > <li className="pb-3 border-b border-gray-300">About us</li></Link>
              <Link href={`/Portfolio`}>  <li className="pb-3 border-b border-gray-300">Portfolio</li></Link>
              
              <Link href={`/`} ><li className="pb-3 border-b border-gray-300">Blog</li></Link>
              <Link href={`/`}><li className="pb-3 border-b border-gray-300">Contact us</li></Link>
            </ul>
