...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="relative text-center text-white lg:top-3 max-w-lg md:max-w-3xl lg:max-w-4xl w-full px-2 sm:px-4 md:px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
          ...
          <button
            className="
              bg-gradient-to-r from-[#3CA270] to-[#163C29]
              font-medium text-white
              px-10 py-2  rounded-full
              transition-all duration-300
              hover:from-[#163C29] hover:to-[#33734F]
